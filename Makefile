...
diagnose:        ## Find out WHY families are confused
	PYTHONPATH=$$PWD/bench-p02-context:$$PYTHONPATH python3 l3-testing/diagnose_twins.py --adapter adapters.agurum:Engine --seed 42 --n-families 12
...
l3-full:         ## Full L3 simulation — 10 families, 3 seeds
	PYTHONPATH=$$PWD/bench-p02-context:$$PYTHONPATH python3 l3-testing/run_l3.py --adapter adapters.agurum:Engine --seeds 42 1337 9919 --n-services 30 --n-families 13 --days 14 --n-train 40 --n-eval 20 --verbose --out l3_full_report.json

l3-stress:       ## Stress test (max params)
	PYTHONPATH=$$PWD/bench-p02-context:$$PYTHONPATH python3 l3-testing/run_l3.py --adapter adapters.agurum:Engine --seeds 42 1337 9999 31415 27182 --n-services 50 --n-families 15 --days 21 --n-train 60 --n-eval 30 --out l3_stress_report.json
